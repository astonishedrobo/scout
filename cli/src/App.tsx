...
import { checkBroadDirectory } from "./dirCheck.js";
import { detectEnvs, type EnvOption } from "./envDetect.js";
...
export const App: React.FC<AppProps> = ({ cwd, configPath }) => {
  ...
  const { baseUrl, isReady, error: serverError } = useServer(serverOpts);
