...
/** Locate the bundled Python source relative to the core dist/ dir.
 *
 * Production (npm installed):
 *   node_modules/scout-core/dist/setup.js  →  ../python/
 *
 * Development (monorepo):
 *   packages/core/dist/setup.js  →  ../../../python/
 */
function bundledPythonDir(): string {
  ...
  // Development: python/ is at the monorepo root
